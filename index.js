...
function findElementGreaterThan(arr, num) {
	...
	const firstGreaterElement = arr.find((elem) => elem > num);
	if (firstGreaterElement !== undefined) {
...
function findIndexByProperty(arr, name) {
	...
	const findIndex = arr.findIndex((elem) => elem.name === name);
	if (findIndex !== -1) {
		return findIndex;
	}
	return -1;
...
function findLastEvenNumber(arr) {
	...
	const lastEvenNum = arr.findLast((elem) => elem % 2 === 0);
	if (lastEvenNum !== undefined) {
		return lastEvenNum;
	}
...
function getPositiveArrayValues(arr) {
	...
	const iteratorToArray = Array.from(arr.values());
	return iteratorToArray.filter((value) => value > 0);
	// Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function sumAndPrint(arr) {
	...
	const sumWithInstial = arr.reduce(
		(accumulator, currentValue) => accumulator + currentValue,
		initialValue
	);
	const iterateArr = arr.forEach((element) => console.log(element));
	return iterateArr, sumWithInstial;
	// Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function flattenSquareAndFilter(arr, threshold) {
	...
	const arrSquare = arrFlat.map((num) => num ** 2);
	return arrSquare.filter((num) => num > threshold);
	// Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function getLastElementsSumAndPrint(arr, n) {
	...
	const arrSlice = arr.slice(-n);
	const initialValue = 0;
	const sumLastElem = arrSlice.reduceRight(
		(accumulator, currentValue) => accumulator + currentValue,
		initialValue
	);
	const iterateArr = arrSlice.forEach((element) => console.log(element));
	return iterateArr, sumLastElem;
	// Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function capitalizeWords(arr) {
	...
	return arr.map((word) => word.at(0).toUpperCase().concat(word.slice(1)));
	// Перевіряємо, чи вхідний параметр є масивом, якщо ні, повертаємо пустий масив
